...
import pojos.payload.DeviceInfo;
import pojos.tokens.RefreshToken;
import repositories.UserDeviceRepository;
...
public class UserDeviceService {
	...
	public void verifyRefreshAvailability(RefreshToken refreshToken) {
		...
		Optional<Boolean> userDeviceRefreshEnabledOpt = userDeviceOpt.map(UserDevice::getIsRefreshActive);
